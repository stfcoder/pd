...
-->
<title>Personnel Department - {$title}</title>
...
-->
	...
	<ul class="deptdir">
		<li><a href="mailto:pdir@star-fleet.com">PDir {$pdir}</a></li>
		<li><a href="mailto:apdir@star-fleet.com">APDir {$apdir}</a></li>
		<li><a href="mailto:2apdir@star-fleet.com">2APDir {$2apdir}</a></li>
