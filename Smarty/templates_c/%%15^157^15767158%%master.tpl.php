<?php /* Smarty version 2.6.16, created on 2009-04-20 06:51:45
         compiled from master.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count_characters', 'master.tpl', 99, false),)), $this); ?>
...
-->
<title>Personnel Department - <?php echo $this->_tpl_vars['title']; ?>
</title>
...
-->
	<div id="nav">
		<ul class="links">
			...
			<li><a href="new-members.php">New Members</a></li>
		</ul>
		
		<ul class="links">
			<li><a href="policies.php">Policies</a></li>
			<li><a href="recommendations.php">Recommendations</a></li>
			<li><a href="ship-profiles.php">Ship Profiles</a></li>
			<li><a href="http://www.star-fleet.com/webb/legal">Terms of Service</a></li>
		</ul>
	</div>

	<ul class="deptdir">
		<li><a href="mailto:pdir@star-fleet.com">PDir <?php echo $this->_tpl_vars['pdir']; ?>
</a></li>
		<li><a href="mailto:apdir@star-fleet.com">APDir <?php echo $this->_tpl_vars['apdir']; ?>
</a></li>
		<li><a href="mailto:2apdir@star-fleet.com">2APDir <?php echo $this->_tpl_vars['2apdir']; ?>
</a></li>
...
Happy coding!
-->
	<?php if (((is_array($_tmp=$this->_tpl_vars['menuBar'])) ? $this->_run_mod_handler('count_characters', true, $_tmp) : smarty_modifier_count_characters($_tmp)) > 0): ?>
	<div class="section">
	...
	<?php endif; ?>
	<div class="section">
		<?php echo $this->_tpl_vars['bodyContent']; ?>
